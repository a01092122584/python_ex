...
var1 = True
var2 = True
print(var1 and var2) #T

var1 = True
var2 = False
print(var1 and var2) #F
...
#범퍼카 탑승 가능 판별
#사용 기준 '신장120cm 이상 170cm 미만인 어린이'
#탑승 가능 True 불가능 False
...
#적자/흑자 판단하기
# 마트 수입과 지출을 입력하면 흑자인지 적자인지 판별하는 프로그램을 도입

imcoming = int(input('수입: '))
outgoing = int(input('지출: '))
result = '흑자' if imcoming > outgoing else '적자'
print(f'result: {result}')
